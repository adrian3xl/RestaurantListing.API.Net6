...
namespace RestaurantListing.API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ResturantsController : ControllerBase
    {
        private readonly ResturantListingDBContext _context;

        public ResturantsController(ResturantListingDBContext context)
        {
            _context = context;
        }
